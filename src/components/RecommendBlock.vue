<template>
  <div class="product_recommend">
    <div class="product_recommend__novel" v-if="novel">
      ...
      <div class="product_recommend__btn_from_sum">
          <button class="btn_from_sum" v-if="from_sum">
              <span>{{ price }}</span>
          </button>
          <button class="btn_sum" v-else>
            <span>{{ price }}</span>
          </button>
      </div>
  </div>
